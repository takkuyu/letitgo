      ...
      <Row className="messages-page-row rounded-lg overflow-hidden mx-0">
        <Col md={4} lg={3} className="messages-page-row__left" >
          ...
          >
            ...
            >
              <Icon iconClassCode="bi bi-arrow-left-circle" size={18} top={-2} mr={7} />Back
            </span>
            <p className="messages-copy icon-comments">Messages</p>
          </div>
          <div >
            <MessageRooms currentUser={user} setMessagesActive={() => setMessagesActive(true)} messagesActive={messagesActive} />
          </div>
        </Col>
        <Col md={8} lg={9} className="messages-page-row__right px-0">
          <Messages currentUser={user} messagesContRef={messagesContRef} messagesActive={messagesActive} />
        </Col>
      </Row>
    </div>
  )
