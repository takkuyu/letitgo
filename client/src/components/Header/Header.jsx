  ...
  return (
    <Fragment>
      <header className="header">
        ...
        <div className="nav-toggle-button" onClick={() => setIsOverlayHeaderActive(!isOverlayHeaderActive)} >
          <span className={isOverlayHeaderActive ? 'icon-times' : 'icon-bars'}></span>
        </div>
      </header>
      {
        isOverlayHeaderActive && (
          <div className="overlay-header">
            ...
            <Navigation closeOverlayHeader={() => setIsOverlayHeaderActive(false)} />
          </div>
        )
      }
    </Fragment>
